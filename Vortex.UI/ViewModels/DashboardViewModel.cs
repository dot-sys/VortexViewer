...
namespace Vortex.UI.ViewModels
{
        ...
        private async void LoadSystemInfo()
        {
            ...
            await Task.Run(() =>
            {
                ...
                System.Windows.Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    HardwareItems.Add(new HardwareItem { Property = "GPU Model", Value = hardware.GpuChipset });
                    HardwareItems.Add(new HardwareItem { Property = "GPU Subsys", Value = hardware.GpuModel });
                    ...
                    HardwareItems.Add(new HardwareItem { Property = "System Drive Model", Value = hardware.HardDriveModel });
                    HardwareItems.Add(new HardwareItem { Property = "System Drive Serial", Value = hardware.HardDriveSerial });
                    ...
                    SoftwareItems.Add(new SoftwareItem { Property = "TPM 2.0 Public Key", Value = software.TpmEkPublicKey });
    ...
    public class HardwareItem
    {
        ...
        // Hardware property value (truncated for display)
        public string Value 
        { 
            get => _fullValue != null && _fullValue.Length > 60 
                ? _fullValue.Substring(0, 57) + "..." 
                : _fullValue;
            set => _fullValue = value;
        }
        
        // Full value for copying
        public string FullValue => _fullValue;
    }
    ...
    public class SoftwareItem
    {
        ...
        // Software property value (truncated for display)
        public string Value 
        { 
            get => _fullValue != null && _fullValue.Length > 60 
                ? _fullValue.Substring(0, 57) + "..." 
    ...
    public class TamperingItem
    {
        ...
        // Tampering property value (truncated for display)
        public string Value 
        { 
            get => _fullValue != null && _fullValue.Length > 60 
                ? _fullValue.Substring(0, 57) + "..." 
